...
public class VideoDbInfo implements Parcelable {
    ...
    public static final String[] COLUMNS = {
            ...
            // scraper infos
            VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE,    // 16
            ...
            VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID,      // 25
    ...
    public ContentValues toContentValues() {
        ...
        if (subtitleTrack >= 0 && audioTrack >= 0) {
            int LeeroyFlixParams = VideoStore.paramsFromTracks(audioTrack, subtitleTrack);
            values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_PLAYER_PARAMS, LeeroyFlixParams);
        }
