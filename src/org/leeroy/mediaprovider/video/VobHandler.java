...
public class VobHandler implements Handler.Callback {
    ...
    private void handleInBackground(String bucket_id) {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                String leeroyflixTitle = c.getString(COLUMN_LEEROYFLIX_TITLE);
                int hidden = c.getInt(COLUMN_HIDE_FILE);
                VobFile vf = new VobFile(id, file, title, hidden, leeroyflixTitle);
    ...
    private static class VobFile {
        ...
        public final String leeroyflixTitle;
        ...
        public VobFile (long id, String file, String title, int hidden, String leeroyflixTitle) {
            this.id = id;
            this.file = new File(file);
            this.title = title;
            this.leeroyflixTitle = leeroyflixTitle;
        ...
        public void updateDatabase(ContentResolver cr) {
            ...
            if (dvdPart == 1) { // we only ever change the name of the _1.vob
                if (newTitle == null) {
                    ...
                    updateTitle =  leeroyflixTitle != null;
                } else if (!newTitle.equals(leeroyflixTitle)) {
