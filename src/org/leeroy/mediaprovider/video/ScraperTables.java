...
public final class ScraperTables {
    ...
    private static final String EPISODE_DELETE_TRIGGER_CREATE =
            ...
            "UPDATE " + VideoOpenHelper.FILES_TABLE_NAME + " SET leeroyflixmediascraper_id=-1, leeroyflixmediascraper_type=-1 " +
            "WHERE leeroyflixmediascraper_id = OLD._id AND leeroyflixmediascraper_type = " + ScraperStore.SCRAPER_TYPE_SHOW + ";" +
            "END";
    ...
    private static final String MOVIE_DELETE_TRIGGER_CREATE =
            ...
            // set scraper type / id to -1 if something is refering this episode
            "UPDATE " + VideoOpenHelper.FILES_TABLE_NAME + " SET leeroyflixmediascraper_id=-1, leeroyflixmediascraper_type=-1 " +
            "WHERE leeroyflixmediascraper_id = OLD._id AND leeroyflixmediascraper_type = " + ScraperStore.SCRAPER_TYPE_MOVIE + ";" +
    ...
    private static final String MOVIE_INSERT_TRIGGER_CREATE =
            ...
            "BEGIN " +
            "UPDATE " + VideoOpenHelper.FILES_TABLE_NAME + " SET leeroyflixmediascraper_id=NEW._id, leeroyflixmediascraper_type=" + ScraperStore.SCRAPER_TYPE_MOVIE +
    ...
    private static final String EPISODE_INSERT_TRIGGER_CREATE =
            ...
            "BEGIN " +
            "UPDATE " + VideoOpenHelper.FILES_TABLE_NAME + " SET leeroyflixmediascraper_id=NEW._id, leeroyflixmediascraper_type=" + ScraperStore.SCRAPER_TYPE_SHOW +
            " WHERE remote_id=NEW.video_id;" +
            "END";
    ...
    public static void upgradeTo(SQLiteDatabase db, int toVersion) {
        ...
        if (toVersion == 39) {
            ...
            db.execSQL("CREATE INDEX files_scraper_idx ON files(leeroyflixmediascraper_id, leeroyflixmediascraper_type)");
